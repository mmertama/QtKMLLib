...
QQmlListProperty<QObject> KmlQmlRenderer::elements(){
    const QQmlListProperty<KmlQmlElement>::CountFunction cf = [](QQmlListProperty<KmlQmlElement>* r)->qsizetype{
        return qobject_cast<KmlQmlRenderer*>(r->object)->d_ptr->elements().count();
    };
    const QQmlListProperty<KmlQmlElement>::AtFunction af = [](QQmlListProperty<KmlQmlElement>* r, qsizetype index)->KmlQmlElement*{
